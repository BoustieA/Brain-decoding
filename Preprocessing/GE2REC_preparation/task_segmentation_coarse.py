...
for file in masked_list:
    ...
    elif fnmatch.fnmatch(file, '*GENE/swar*'):
            gene_list.append(os.path.join(path, file))

for file in masked_list:
    if fnmatch.fnmatch(file, '*RAPPEL/war*'):
        rap_list.append(os.path.join(path, file))
    elif fnmatch.fnmatch(file, '*RAPPEL/swar*'):
            rap_list.append(os.path.join(path, file))
...
for file in gene_list:
    ...
    l4 = []
    l5 = []
    filename1 = file[:-9] + "1_gene_train.nii"
    filename2 = file[:-9] + "2_gene_train.nii"
    filename3 = file[:-9] + "3_gene_train.nii"
    filename4 = file[:-9] + "4_gene_train.nii"
    filename5 = file[:-9] + "5_gene_train.nii"
    img = nib.load(file)
...
for file in rap_list:
    ...
    l4 = []
    l5 = []
    filename1 = file[:-9] + "1_rap_train.nii"
    filename2 = file[:-9] + "2_rap_train.nii"
    filename3 = file[:-9] + "3_rap_train.nii"
    filename4 = file[:-9] + "4_rap_train.nii"
    filename5 = file[:-9] + "5_rap_train.nii"
    img = nib.load(file)    
    data1 = img.slicer[:,:,:,0:16]
    data2 = img.slicer[:,:,:,5:16]
